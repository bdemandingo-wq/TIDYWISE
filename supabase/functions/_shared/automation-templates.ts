 ...
 * below this header. The editor validates against that copy; this one resolves
 * at send time. If they drift, an owner will be allowed to save a token the
 * sender cannot resolve. Run src/lib/automationTemplates.test.ts after editing.
 */
