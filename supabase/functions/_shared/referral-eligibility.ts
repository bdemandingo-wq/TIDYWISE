 ...
 *
 * KEEP IN SYNC: this file is a VERBATIM COPY of `src/lib/referralEligibility.ts`
 * below its header. That file is canonical; edit it there and re-copy here.
 * The duplication exists because the webhook and the reward granter run in Deno
 * and cannot import from `src/`. Same arrangement as automation-templates.ts.
 *
