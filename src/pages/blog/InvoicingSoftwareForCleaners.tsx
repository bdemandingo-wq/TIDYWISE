...
export default function InvoicingSoftwareForCleaners() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <BreadcrumbJsonLd crumbs={[{ name: "Home", path: "/" }, { name: "Blog", path: "/blog" }, { name: 'Invoicing Software for Cleaning Businesses Guide', path: '/blog/invoicing-software-for-cleaning-business' }]} />
