...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 pt-[calc(env(safe-area-inset-top,0px)+1.5rem)] pointer-events-none sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[460px]",
      className,
    )}
    {...props}
  />
...
>(({ className, variant, ...props }, ref) => {
  return <ToastPrimitives.Root ref={ref} className={cn(toastVariants({ variant }), "pointer-events-auto", className)} {...props} />;
});
